...
<!-- modeltime issue with linear regression -->
...
conditionalPanel(
  ...
  h5("Algorithm hyperparameters: "),
  awesomeCheckbox(inputId = "auto_ets", label = "Automatic estimation?", value = FALSE),
  selectInput(inputId = "error", label = "Error", choices = c("additive", "multiplicative"), selected = "additive"),
  selectInput(inputId = "trend", label = "Trend", choices = c("additive", "multiplicative", "none"), selected = "none"),
  selectInput(inputId = "season", label = "Seasonality", choices = c("additive", "multiplicative", "none"), selected = "none"),
  selectInput(inputId = "damping", label = "Damped Trend", choices = c("damped", "none"), selected = "none"),
...
conditionalPanel(
  ...
  h5("Algorithm hyperparameters: "),
  awesomeCheckbox(inputId = "auto_arima", label = "Automatic estimation?", value = FALSE),
...
conditionalPanel(
  ...
  h5("Algorithm hyperparameters: "),
  awesomeCheckbox(inputId = "auto_tbats", label = "Automatic estimation?", value = FALSE),
  numericInput(inputId = "tbats_seasonal_period_1", label = "Seasonal Period 1", value = 12, min = 0, max = Inf, step = 1),
  numericInput(inputId = "tbats_seasonal_period_2", label = "Seasonal Period 2", value = 0, min = 0, max = Inf, step = 1),
  numericInput(inputId = "tbats_seasonal_period_3", label = "Seasonal Period 3", value = 0, min = 0, max = Inf, step = 1)
)
...
conditionalPanel(
  ...
  h5("Algorithm hyperparameters: "),
  awesomeCheckbox(inputId = "auto_stlm", label = "Automatic estimation?", value = FALSE),
  prettyRadioButtons(inputId = "trend_model", label = "Trend Model", choices = c("ETS", "ARIMA"), inline = TRUE, selected = "ETS"),
  numericInput(inputId = "stlm_seasonal_period_1", label = "Seasonal Period 1", value = 12, min = 0, max = Inf, step = 1),
  numericInput(inputId = "stlm_seasonal_period_2", label = "Seasonal Period 2", value = 0, min = 0, max = Inf, step = 1),
  numericInput(inputId = "stlm_seasonal_period_3", label = "Seasonal Period 3", value = 0, min = 0, max = Inf, step = 1)
)
...
conditionalPanel(
  ...
  h5("Algorithm hyperparameters: "),
  awesomeCheckbox(inputId = "auto_prophet", label = "Automatic estimation?", value = FALSE),
  prettyRadioButtons(inputId = "growth", label = "Growth", choices = c("linear", "logistic"), inline = TRUE, selected = "linear"),
  conditionalPanel(
    condition = "input.growth == 'logistic'",
    numericInput(inputId = "logistic_cap", label = "Logistic Cap", value = 0, min = -Inf, max = Inf, step = 1),
    numericInput(inputId = "logistic_floor", label = "Logistic Floor", value = 0, min = -Inf, max = Inf, step = 1)
  ),
  # numericInput(inputId = "logistic_cap", label = "Logistic Cap", value = 0, min = -Inf, max = Inf, step = 1),
  # numericInput(inputId = "logistic_floor", label = "Logistic Floor", value = 0, min = -Inf, max = Inf, step = 1),
  numericInput(inputId = "changepoint_num", label = "Changepoints (num)", value = 25, min = 0, max = Inf, step = 1),
  numericInput(inputId = "changepoint_range", label = "Changepoints (range)", value = 0.8, min = 0, max = 1),
  prettyRadioButtons(inputId = "season", label = "Seasonality", choices = c("additive", "multiplicative"), inline = TRUE, selected = "additive"),
  awesomeCheckbox(inputId = "seasonality_yearly", label = "Yearly Seasonality?", value = TRUE),
  awesomeCheckbox(inputId = "seasonality_weekly", label = "Weekly Seasonality?", value = FALSE),
  awesomeCheckbox(inputId = "seasonality_daily", label = "Daily Seasonality?", value = FALSE),
  numericInput(inputId = "prior_scale_changepoints", label = "Changepoint Flexibility", value = 0.05, min = 0, max = 1),
  numericInput(inputId = "prior_scale_seasonality", label = "Seasonality Stength", value = 10, min = 0, max = Inf),
  numericInput(inputId = "prior_scale_holidays", label = "Holidays Strength", value = 10, min = 0, max = Inf)
)
...
# XGBoost
conditionalPanel(
  condition = "input.method == 'XGBoost'",
  h5("Algorithm hyperparameters: "),
  numericInput(inputId = "mtry", label = "Random Predictors", value = 5, min = 0, max = Inf, step = 1),
  numericInput(inputId = "trees", label = "Trees", value = 15, min = 1, max = Inf, step = 1),
  numericInput(inputId = "min_n", label = "Min Node Size", value = 1, min = 1, max = Inf, step = 1),
  numericInput(inputId = "tree_depth", label = "Tree Depth", value = 6, min = 1, max = Inf),
  numericInput(inputId = "learn_rate", label = "Learning Rate", value = 0.3, min = 0, max = 1),
  numericInput(inputId = "loss_reduction", label = "Min Loss Reduction", value = 0, min = 0, max = 1),
  numericInput(inputId = "sample_size", label = "Sample Size", value = 1, min = 0, max = 1)
)
```

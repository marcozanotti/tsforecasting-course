...
info_path <- list.files("exam/Dataset/", pattern = "\\.csv", full.names = TRUE)
...
train_paths <- list.files("exam/Dataset/Train/", full.names = TRUE)
train <- map(train_paths, read_csv)
test_paths <- list.files("exam/Dataset/Test/", full.names = TRUE)
...
write_rds(m4_sample, file = "data/exam_dataset.rds")
# read_rds("data/exam_dataset.rds")
